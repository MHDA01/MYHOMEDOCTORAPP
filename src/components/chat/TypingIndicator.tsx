      ...
      <div className="flex w-full max-w-5xl gap-4">
        ...
        <div className="rounded-2xl border border-border bg-white px-5 py-4">
          <div className="flex items-center gap-1.5">
            ...
            <span className="h-2 w-2 rounded-full bg-muted-foreground/50 animate-bounce [animation-delay:140ms]" />
            <span className="h-2 w-2 rounded-full bg-muted-foreground/50 animate-bounce [animation-delay:280ms]" />
          </div>
        </div>
      </div>
    </div>
