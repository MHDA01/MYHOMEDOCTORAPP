      ...
      <div className="container mx-auto text-center px-6">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
          {problems.map((problem) => (
            <Card key={problem.text} className="bg-white p-6 flex flex-col items-center text-center hover:shadow-xl transition-shadow duration-300 border-0 rounded-xl">
